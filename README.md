...
#### 1. To understang the objective, I bypass the built-in logic to  display the decoded message directly. The alert message was obtained by decoding the provided base64 strings:
