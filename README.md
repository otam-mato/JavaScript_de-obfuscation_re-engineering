...
To switch the 'clue' to 'RIPLEY', some user agent manipulations are necessary. Please see the screenshot below for details. 
...
The sum is 499 (which is obviously doesn't satisfy the needed 469)
